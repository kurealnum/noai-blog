  ...
  return (
    <div className="text-based-page">
      ...
      <p className="centered-text">
        Large language models have no place in human writing. If you agree, we
      ...
      <p>
        ...
        had wasn’t hateful people, a lack of moderation, accessibility, or
        anything else. The biggest issue Dev.to had was the influx of AI
        generated content. ChatGPT was just getting big, and no one had any idea
        what to do about it. However, I had a few ideas that I organized and
        shared as a research paper (which I also submitted for my AP English
        final – a win-win), and thus, the idea of byeAI was born. Since
