...
DJANGORESIZED_DEFAULT_SCALE = environ.get("DJANGORESIZED_DEFAULT_SCALE")
DJANGORESIZED_DEFAULT_QUALITY = environ.get("DJANGORESIZED_DEFAULT_QUALITY")
DJANGORESIZED_DEFAULT_KEEP_META = environ.get("DJANGORESIZED_DEFAULT_KEEP_META")
DJANGORESIZED_DEFAULT_FORCE_FORMAT = environ.get("DJANGORESIZED_DEFAULT_FORCE_FORMAT")
DJANGORESIZED_DEFAULT_FORCE_EXTENSIONS = {
    environ.get("DJANGORESIZED_FORCE_EXTENSION_KEY"),
    environ.get("DJANGORESIZED_DEFAULT_FORCE_EXTENSION_VALUE"),
}
